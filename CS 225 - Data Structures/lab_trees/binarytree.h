...
class BinaryTree
{
    public:
        ...
        bool isOrderedHelp(Node * subRoot) const;
         ...
         */
         ...
         void getPathsHelp(Node* subRoot, vector<vector<T> > &paths, vector<T> tmp) const;

        int sumDistances() const;
        int sumDistancesHelp(Node* subroot,int dist) const;
