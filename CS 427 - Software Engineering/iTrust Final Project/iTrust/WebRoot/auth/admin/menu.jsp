...
<div class="panel panel-default">
	...
	<div class="panel-body" id="other-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/admin/sendReminder.jsp">Send Appointment Reminders</a></li>
			<li><a href="/iTrust/auth/admin/reminderOutbox.jsp">Reminder Message Outbox</a></li>
			<li><a href="/iTrust/auth/admin/allergyWarning.jsp">Send Allergy Warnings</a></li>
			<li><a href="/iTrust/auth/FilteredTransactionLog.jsp">View Filtered Transaction Log</a></li>
		</ul>
	</div>
</div>
