...
<%
	if (!userName.contains(".PREREGISTERED")) {
%>
...
%>
<p>You are successfully pre-registered. You need an HCP to activate your account in order to use the iTrust medical system.
