...
public enum TransactionType {
	...
	/**PATIENT_PREREGISTER*/
	PATIENT_PREREGISTER(104, "User preregistered as a patient", "created a preregistered user", false),
	/**PATIENT_PREREG_ACTIVATE*/
	PATIENT_PREREG_ACTIVATE(105, "Activate preregistered patient", "activate a preregistered user", false),
	/**PATIENT_PREREG_DEACTIVATE*/
	PATIENT_PREREG_DEACTIVATE(106, "Deactivate preregistered patient", "deactivate a preregistered user", false),
	/**LHCP_CREATE*/
