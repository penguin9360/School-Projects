...
public class ResetPasswordAction {
	...
	public String checkRole(long mid, String role) throws ITrustException {
		if(role == null || !(role.equals("patient") || role.equals("hcp") ||
				role.equals("uap") || role.equals("pha") || role.equals("er") || role.equals("lt"))) {
			return null;
		}
		try {
			if (role.equals(authDAO.getUserRole(mid).getUserRolesString()))
				return role;
			else
				return null;
