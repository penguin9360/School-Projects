...
public class TestDataGenerator {
	...
	/**
	 * Adds patient Addy Bog, used in the testing of UC-Air.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient60() throws FileNotFoundException, SQLException,
			IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient60.sql");
	}
	/**
	 * Adds patient Al Pat, used in the testing of UC-Air.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient61() throws FileNotFoundException, SQLException,
			IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient61.sql");
	}
	/**
	 * Adds patient Pag Forg, used in the testing of UC-Air.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient62() throws FileNotFoundException, SQLException,
			IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient62.sql");
	}
	/**
	 * Adds patient Rose Fog, used in the testing of UC-Air.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient63() throws FileNotFoundException, SQLException,
			IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient63.sql");
	}
	/**
	 * Adds patient RJ Forler, used in the testing of UC-Air.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient64() throws FileNotFoundException, SQLException,
			IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient64.sql");
	}
	...
	public void uc20() throws FileNotFoundException, SQLException,
			IOException {
